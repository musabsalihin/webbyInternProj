    ...
    <div class="max-w-7xl h-full mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <form class="mt-4" method="post" action="{{route('post.add')}}">
            ...
            <div class="my-4">
                ...
                <input class="w-full rounded-2xl border-gray-400" id="title" name="title" type="text">
            </div>
            <div class="my-4">
            ...
            <div class="my-4">
                ...
                <textarea cols="30" rows="10" id="editor" name="description"></textarea>
            </div>
            <div class="flex justify-end">
                ...
                type="submit" name="action" value="Create Post">
            </div>
        </form>
    </div>
        <script>
